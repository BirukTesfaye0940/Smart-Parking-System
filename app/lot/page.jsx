...
export default function ParkingLotsList() {
  const [lots, setLots] = useState([]);
  const [selectedLot, setSelectedLot] = useState(null); // for map modal
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-4 w-full max-w-2xl relative shadow-xl">
            ...
            <iframe
              ...
              src={`https://www.google.com/maps/embed/v1/view?key=YOUR_GOOGLE_MAPS_API_KEY&center=${selectedLot.latitude},${selectedLot.longitude}&zoom=16`}
            ></iframe>
          </div>
        </div>
      )}
